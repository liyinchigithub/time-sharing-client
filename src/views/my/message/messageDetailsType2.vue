...
<template>
  <div>
    ...
    <div class="card">
      <div>
        <div class="cardRow"><span>消息类型：预订订单</span></div>
        <div class="cardRow"><span>发送时间：2020/12/12 12:23</span></div>
        <div class="cardRow"><span>来源用户：头像 王小帅</span></div>
        <div class="cardRow"><span>预订结果：预订</span></div>
        <div class="cardRow"><span>租赁时间段：2020/12/12 12:00~2020/12/12 18:00</span></div>
        <div class="cardRow"><span>预订金额：200 ~ 300 元</span></div>
      </div>
    </div>
    ...
    <div class="card2">
      ...
      <van-row>
        <van-col span="25" class="col">
          <!-- 关联房源租赁时间段 -->
          租赁时间段： {{ associatedHousingLeasableTime }}
        </van-col>
        <van-col span="25" class="col">
          <!-- 关联房源标签 -->
...
import { getMessageItemList,getMessageDetail } from '@/api/my/myMessage/myMessage.js'
export default {
  name: 'messageDetails', // 消息详情页（预订订单）
  components: {},
  data() {
    return {
      bookOrderID: '', // 预订订单ID
      ...
      sourceOfUser: '', //来源用户
      ReservationResults: '', // 预订结果
      correlationPropertiesID: '', // 预订订单ID，关联房源
      LeasableTime: '', // 租赁时间段
      reservationAmount: '', // 预订金额
      // 关联房源信息
