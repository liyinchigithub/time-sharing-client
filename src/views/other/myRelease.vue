    ...
    <van-pull-refresh v-model="isLoading" success-text="刷新成功" @refresh="onRefresh">
      ...
      >
        ...
        <div class="card" v-for="(item, index) in myReleaseItemList" :key="index">
          <div>
            <van-row @click="toOrderDetail(item.orderID)">
              <!-- 需求单-地址 -->
              <van-col span="10">
              ...
              <div style="margin-left: 5px">
                <van-col span="25">
                  ...
                  <van-row>
                    ...
                    <div style="margin-left: 15px; margin-top: 8px; font-size: 17px">
                      <van-row>
                        <van-col span="22" @click="toOrderDetail(item.orderID)"
...
export default {
  ...
  data() {
    return {
      ...
      myReleaseItemList: [
        {
          requireOrderID: '1',
          requireOrderAddress: '杭州-拱墅区1',
          tags: ['网红打卡', '安静文艺', '情侣圣地', '企业会议'],
          requireOrderCreateTime: '2020/12/12 12:23:23',
          requireOrderStatus: '进行中'
        },
        {
          requireOrderID: '2',
          requireOrderAddress: '杭州-拱墅区2',
          tags: ['网红打卡', '安静文艺', '情侣圣地', '企业会议'],
          requireOrderCreateTime: '2020/12/12 12:23:23',
          requireOrderStatus: '已完成'
        },
        {
          requireOrderID: '3',
          requireOrderAddress: '杭州-拱墅区3',
          tags: ['网红打卡', '安静文艺', '情侣圣地', '企业会议'],
          requireOrderCreateTime: '2020/12/12 12:23:23',
          requireOrderStatus: '已取消'
        },
        {
          requireOrderID: '4',
          requireOrderAddress: '杭州-拱墅区4',
          tags: ['网红打卡', '安静文艺', '情侣圣地', '企业会议', '派对'],
          requireOrderCreateTime: '2020/12/12 12:23:23',
          requireOrderStatus: '已失效'
        }
      ],
      // 是否显示取消按钮
      showCancel: true,
  ...
  methods: {
    ...
    toOrderDetail(orderID) {
      this.$router.push(`/orderUser/${orderID}`)
    },
    /**
     * @method onRefresh
     * @description 下拉刷新
